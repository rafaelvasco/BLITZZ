...
namespace FreeTypeSharp
{
    public unsafe class FreeTypeFaceFacade
    {
        ...
        /// <summary>
        /// Gets the horizontal bearing X value of the current glyph.
        /// </summary>
        public int GlyphHoriBearingX
        {
            get => _FaceRec->glyph->metrics.horiBearingX.ToInt32() >> 6;
        }


        /// <summary>
        /// Gets the horizontal bearing Y value of the current glyph.
        /// </summary>
        public int GlyphHoriBearingY
        {
            get => _FaceRec->glyph->metrics.horiBearingY.ToInt32() >> 6;
        }
